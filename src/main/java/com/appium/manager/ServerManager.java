...
//				.withLogFile(new File(params.getPlatformName() + "_" + params.getDeviceName() + File.separator + "Server.log")));
	...
	public AppiumDriverLocalService getAppiumServiceForMac() {
		...
		environment.put("PATH",
				"/Library/Internet Plug-Ins/JavaAppletPlugin.plugin/Contents/Home/bin:/Users/\"+UsernameUtils.getUserName()+\"/Library/Android/sdk/tools:/Users/\"+UsernameUtils.getUserName()+\"/Library/Android/sdk/platform-tools:/opt/homebrew/bin:/opt/homebrew/sbin:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/Library/Apple/usr/bin"
						+ System.getenv("PATH"));
